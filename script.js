window.addEventListener('load', function(){
    ...
    class Particle{ // deals with falling screws corks and bolts comes from damaged enimy //
        ...
        draw(context){
            context.save(); // takes note of current canvas state
            context.translate(this.x, this.y);
            context.rotate(this.angle);
            context.drawImage(this.image, this.frameX * this.spriteSize, this.frameY * this.spriteSize, this.spriteSize, this.spriteSize, this.size * -0.5, this.size * -0.5, this.size, this.size);
            context.restore(); // look for its associative save method and reset all canvas setting to that save method
        }
    }
    ...
    class UI {  // draw score timer and other things which needs to display //
        ...
        draw(context){
            ...
            //ammo
            if (this.game.player.powerUp) context.fillStyle = '#ffffbd'; // green
    ...
    class Game { // All logic will come togher inside this //
        ...
        draw(context){
            ...
            this.enemies.forEach(enemy => enemy.draw(context)); // for particles
            this.explosions.forEach(explosion => explosion.draw(context)); // for explosion
